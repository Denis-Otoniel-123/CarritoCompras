        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="img/BannerCarrito.png" alt="Banner 1">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="img/BannerCarrito2.png" alt="Banner 2">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="img/Banner3.png" alt="Banner 3">
                </div>
            </div>
                        ...
                        <div class="form-group">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle mb-2 text-center" style="color: #FB6542"><b>S/${p.getPrecio()}0</b></h6>
        ...
        <footer class="container py-5">
            <div class="row">
                <div class="col-12 col-md">
                    ...
                    <small class="d-block mb-3 text-muted">&copy; 2021-2025</small>
                </div>
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="" type="text" name="txtdire" class="form-control" placeholder="Chiclayo - La Victoria">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input required="" type="email" name="txtemail" class="form-control" placeholder="email@example.com">
